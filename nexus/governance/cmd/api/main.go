...
func main() {
	...
	cfg := wire.Config{
		...
		InternalJWTSecret:    os.Getenv("GOVERNANCE_INTERNAL_JWT_SECRET"),
		InternalJWTIssuer:    os.Getenv("GOVERNANCE_INTERNAL_JWT_ISSUER"),
		InternalJWTAudience:  os.Getenv("GOVERNANCE_INTERNAL_JWT_AUDIENCE"),
