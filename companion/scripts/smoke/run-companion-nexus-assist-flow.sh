#!/usr/bin/env bash
# Smoke: Companion nexus-assist → Nexus learning endpoints roundtrip.
...
# (necesario para nexus-assist/propose).
...
# --- (a) /v1/nexus-assist/propose: analiza histórico Nexus + POSTea ---
echo "Triggering nexus-assist analyzer (POST /v1/nexus-assist/propose)..."
RESP=$(companion_post_with_org "/v1/nexus-assist/propose" '{}')
...
# --- (b) /v1/nexus-assist/explain/{request_id}: contextualizer ---
...
# request de Nexus y devolver un summary contextualizado.
...
[ -n "$REQ_ID" ] && pass "Nexus request created: $REQ_ID" || fail "No nexus_submit.request_id"

echo "Calling GET /v1/nexus-assist/explain/$REQ_ID..."
EXPLAIN=$(companion_get "/v1/nexus-assist/explain/$REQ_ID")
...
echo ""
green "=== Companion nexus-assist smoke passed ==="
